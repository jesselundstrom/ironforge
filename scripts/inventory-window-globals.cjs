...
const knownOwners = new Map([
  ...
  ['showSportReadinessCheck', 'src/app/services/workout-ui-actions.ts'],
  ['selectSportReadiness', 'src/app/services/workout-ui-actions.ts'],
  ['cancelSportReadinessCheck', 'src/app/services/workout-ui-actions.ts'],
  ['getSportCheckPromptSnapshot', 'src/app/services/workout-ui-actions.ts'],
  ['showSessionSummary', 'src/app/services/workout-ui-actions.ts'],
  ['openExerciseGuide', 'src/app/services/workout-ui-actions.ts'],
  ['closeExerciseGuide', 'src/app/services/workout-ui-actions.ts'],
  ['getExerciseGuidePromptSnapshot', 'src/app/services/workout-ui-actions.ts'],
  ['refreshExerciseGuideModal', 'src/app/services/workout-ui-actions.ts'],
  ...
  ['addExerciseByName', 'src/stores/workout-store.ts'],
  ['applyQuickWorkoutAdjustment', 'src/stores/workout-store.ts'],
  ['undoQuickWorkoutAdjustment', 'src/stores/workout-store.ts'],
