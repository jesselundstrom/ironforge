...
const STRINGS={
  en:{
    ...
    'rest_day.tip.7':'After a hard session, extra fluids help more than you think.',
    ...
    'rest_day.tip.10':'Move gently and finish feeling better than you started.',
    ...
    'rest_day.tip.20':'Progress comes from training well and recovering on purpose.',
    ...
    'onboarding.recommend.first_step_with_time':'Start with {session} today. Keep it around {time}.',
    'onboarding.recommend.first_step_default':'Start with {session} today. Follow the first week below as your starting map.',
    ...
    'history.stats_empty_sub':'Complete a few workouts to see your training trends.',
    ...
    'workout.coach_note.tm_increase':'Strength up: {lift} +{delta}kg → now {tm}kg',
    'workout.coach_note.week_advance':'Week {week} starts now. Build on it.',
    'workout.coach_note.cycle_advance':'Cycle {cycle} starts — new progression block.',
    'workout.coach_note.tough_session':'Tough session — rest well and come back strong.',
    'workout.coach_note.partial_session':'Partial session logged. Any training counts — consistency wins.',
    ...
    'nutrition.clear.body':'This will delete today\'s nutrition session and meal coaching.',
    'nutrition.empty.kicker':'AI NUTRITION COACH',
    'nutrition.empty.title':'Your daily nutrition coach',
    'nutrition.empty.body':'Pick a guided action below and get personalised nutrition advice for today.',
    ...
    'nutrition.setup.body':'Add your Claude API key to use the Nutrition Coach. The key stays on this device, and nutrition requests are sent directly from this browser to Anthropic.',
    'nutrition.setup.save':'Save & Start',
    'nutrition.setup.help':'Get your API key at console.anthropic.com. Use a personal key and avoid shared devices.',
    ...
    'nutrition.error.rate_limit':'Rate limit reached \u2014 wait a moment and try again.',
    ...
    'nutrition.error.offline':'You are offline. Connect to the internet and try again.',
    ...
    'nutrition.banner.setup_body':'Set up your body profile for personalised advice',
    ...
    'settings.claude_api_key.help':'Get your API key at console.anthropic.com. It stays on this device, and nutrition requests are sent directly from this browser to Anthropic. Use a personal key and avoid shared devices.',
    'settings.claude_api_key.save':'Save Key',
    'settings.claude_api_key.saved_hint':'A key is already saved on this device. Enter a new one only if you want to replace it.',
    ...
    'program.forge.character.deload':'Deload — lighter loads, recovery focus',
    'program.forge.character.heavy':'Heavy — top sets at {pct}% TM',
    'program.forge.character.strength':'Strength — {pct}% TM, controlled volume',
    'program.forge.character.volume':'Hypertrophy — {pct}% TM, build volume',
    'program.forge.note.deload':'Week {week} of {total} — deload. Light and easy, let recovery happen.',
    ...
    'program.w531.character.amrap':'1+ Week — push AMRAP on last set at {pct}%',
    ...
    'program.w531.note.test':'Cycle {cycle}, TM Test — push for max reps to validate training maxes.',
    'program.w531.note.deload':'Cycle {cycle}, Deload — easy sets, focus on recovery.',
    'program.w531.note.amrap':'Cycle {cycle}, {scheme} — push for max reps on every AMRAP set.',
    'program.w531.note.default':'Cycle {cycle}, {scheme} — complete all prescribed sets cleanly.',

    'program.sl.character.normal':'Linear 5×5 — add weight on success',
    'program.sl.note.default':'Session {count} · Workout {next}. Add weight if all 5×5 completed last time.',

    'program.cfb.character.normal':'Full body — varied exercises',
    'program.cfb.note.default':'Session {count}{streak}. Focus on effort and form.',
    ...
    'program.hs.note.deload':'Cycle {cycle}, Week {week} — deload. Lighter loads, let your body recover.',
    'program.hs.note.default':'Cycle {cycle}, Week {week} of 8 — {block} phase. Stay consistent with prescribed volume.'
  },
  fi:{
    'common.undo':'Kumoa',
    ...
    'dashboard.sessions_done':'Kaikki {total} treeniä tehty. Lepää ja palaudu.',
    ...
    'dashboard.plan.deload':'Palautuminen laahaa, joten pidä päivä kevyenä ja käsittele se kevennyksenä. {count} treeniä on jäljellä tällä viikolla.',
    'dashboard.plan.train_light':'Treenaa tänään kevyemmin',
    'dashboard.plan.train_light_body':'Voit silti treenata, mutta pidä rasitus maltillisena ja vältä turhaa grindia. {count} treeniä on jäljellä tällä viikolla.',
    'dashboard.plan.shorten':'Lyhyt treeni tänään',
    'dashboard.plan.shorten_body':'Tee päätyö ensin ja karsi apuliikkeitä pysyäksesi aikaraamissa. {count} treeniä on jäljellä tällä viikolla.',
    'dashboard.plan.avoid_legs':'Lajikuorma on tänään korkea, joten suuntaa treeni pois raskaasta jalkatyöstä aina kun mahdollista. {count} treeniä on jäljellä tällä viikolla.',
    'dashboard.plan.train':'Palautuminen näyttää riittävän hyvältä normaaliin treeniin tänään. {count} treeniä on jäljellä tällä viikolla.',
    'dashboard.today_done':'Päivän työ tehty',
    'dashboard.today_done_badge':'Päivä hoidettu',
    'dashboard.today_done_coach_title':'Hyvä työ',
    'dashboard.today_done_coach_body':'Tämän päivän päätyö on jo kasassa. Anna palautumiselle työrauha ja tule seuraavaan treeniin tuoreena.',
    'dashboard.today_done_body':'Salitreeni on jo kirjattu tälle päivälle. Hyvä työ. Anna palautumiselle tilaa ja tule seuraavaan treeniin terävänä.',
    'dashboard.today_done_body_multi':'Olet kirjannut tälle päivälle jo {count} salitreeniä. Hyvä työ. Sulje päivä rauhassa ja tule seuraavaan treeniin tuoreena.',
    'dashboard.today_done_with_sport':'Salitreeni ja lajitreeni on jo kirjattu tälle päivälle. Vahva päivä. Anna nyt palautumiselle tilaa tehdä työnsä.',
    'common.program':'Ohjelma',
    'training.commentary.workout.kicker':'Tämän päivän päätös',
    'training.commentary.rest.title':'Viikko valmis!',
    'training.commentary.rest.dashboard_summary':'Kaikki suunnitellut treenit on jo tehty tälle viikolle. Lepää ja palaudu.',
    'training.commentary.rest.dashboard_focus_support':'Kaikki suunnitellut treenit on jo tehty tälle viikolle. Lepää ja palaudu.',
    'training.commentary.rest.dashboard_coach':'Kaikki suunnitellut treenit on jo tehty tälle viikolle. Lepää ja palaudu.',
    ...
    'training.commentary.deload.dashboard_summary':'Palautuminen laahaa, joten pidä päivä kevyenä ja käsittele se kevennyksenä. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.deload.dashboard_focus_support':'Palautuminen laahaa, joten pidä päivä kevyenä ja käsittele se kevennyksenä. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.deload.dashboard_coach':'Palautuminen laahaa, joten pidä päivä kevyenä ja käsittele se kevennyksenä. {count} treeniä on jäljellä tällä viikolla.',
    ...
    'training.commentary.train_light.dashboard_summary':'Voit silti treenata, mutta pidä rasitus maltillisena ja vältä turhaa grindia. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train_light.dashboard_focus_support':'Voit silti treenata, mutta pidä rasitus maltillisena ja vältä turhaa grindia. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train_light.dashboard_coach':'Voit silti treenata, mutta pidä rasitus maltillisena ja vältä turhaa grindia. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train_light.workout_summary':'Voit treenata tänään, mutta pidä kuormitus varovaisempana ja anna treenin hengittää.',
    ...
    'training.commentary.shorten.dashboard_summary':'Tee päätyö ensin ja karsi apuliikkeitä pysyäksesi aikaraamissa. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.shorten.dashboard_focus_support':'Tee päätyö ensin ja karsi apuliikkeitä pysyäksesi aikaraamissa. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.shorten.dashboard_coach':'Tee päätyö ensin ja karsi apuliikkeitä pysyäksesi aikaraamissa. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.shorten.workout_summary':'Tee päätyö ensin. Lisätyötä leikataan, jotta pysyt aikarajassa.',
    'training.commentary.shorten.workout_start_toast':'Lyhyt treenisuunnitelma',
    ...
    'training.commentary.sport_aware.dashboard_summary':'Lajikuorma on tänään korkea, joten suuntaa treeni pois raskaasta jalkatyöstä aina kun mahdollista. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.sport_aware.dashboard_focus_support':'Lajikuorma on tänään korkea, joten suuntaa treeni pois raskaasta jalkatyöstä aina kun mahdollista. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.sport_aware.dashboard_coach':'Lajikuorma on tänään korkea, joten suuntaa treeni pois raskaasta jalkatyöstä aina kun mahdollista. {count} treeniä on jäljellä tällä viikolla.',
    ...
    'training.commentary.sport_aware.workout_start_toast':'Lajikuorman huomioiva treeni',
    ...
    'training.commentary.train.dashboard_summary':'Palautuminen näyttää riittävän hyvältä normaaliin treeniin tänään. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train.dashboard_focus_support':'Palautuminen näyttää riittävän hyvältä normaaliin treeniin tänään. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train.dashboard_coach':'Palautuminen näyttää riittävän hyvältä normaaliin treeniin tänään. {count} treeniä on jäljellä tällä viikolla.',
    'training.commentary.train.workout_summary':'Voit treenata normaalisti tänään.',
    ...
    'training.adjustment.short_session_accessories_trimmed.body':'Apuliikkeitä karsittiin lyhyempää treeniä varten.',
    'training.adjustment.aux_volume_reduced.body':'Apuliikkeiden volyymia vähennettiin aikakattoon sopivaksi.',
    'training.adjustment.sport_support_trimmed.body':'Apuliikkeitä poistettiin, jotta treeni pysyy terävämpänä lajin tukemista varten.',
    ...
    'training.adjustment.sport_both.body':'Jalkoja kuormittavaa lajia on tämän treenin molemmin puolin, joten alavartalotyötä karsittiin.',
    ...
    'training.adjustment.program_shoulder_trimmed.body':'Olkapäälle herkkää pystysuuntaista avustavaa työtä priorisoitiin alemmaksi tässä treenissä.',
    ...
    'rest_day.tip.4':'Usein hyvä palautuminen on vain ruokaa, rauhaa ja unta.',
    'rest_day.tip.5':'Aloita päivä vedellä ja pysy janon edellä.',
    'rest_day.tip.6':'Juot pitkin päivää mieluummin kuin kurot illalla kiinni.',
    'rest_day.tip.7':'Kovan treenin jälkeen lisäneste auttaa yllättävän paljon.',
    ...
    'rest_day.tip.10':'Liiku rauhallisesti ja lopeta paremmalla tunteella kuin aloitit.',
    'rest_day.tip.11':'Valitse yksi kireä kohta ja anna sille huomiota.',
    'rest_day.tip.12':'Pitkät uloshengitykset auttavat rentoutumaan asentoihin.',
    'rest_day.tip.13':'Lyhyt kävely riittää hyvin aktiiviseksi palautumiseksi.',
    ...
    'rest_day.tip.16':'Palauttavan liikkeen pitäisi tuntua melkein liian helpolta.',
    ...
    'rest_day.tip.20':'Kehitys syntyy hyvästä treenistä ja tarkoituksellisesta palautumisesta.',
    'dashboard.progress_complete':'Viikon tavoite täynnä',
    'dashboard.progress_remaining_one':'1 treeni jäljellä tällä viikolla',
    'dashboard.progress_remaining_many':'{count} treeniä jäljellä tällä viikolla',
    'dashboard.sport_sessions_week':'Tällä viikolla kirjattu {count} {sport}-treeniä',
    ...
    'onboarding.step.1.sub':'Nämä rajat ohjaavat taajuutta, treenin lyhentämistä ja ohjelman sopivuutta.',
    ...
    'onboarding.step.4.sub':'Ohjatun aloituksen jälkeen sinulla pitäisi olla selkeä ohjelma, ensimmäinen viikko ja ensimmäinen treeni.',
    ...
    'onboarding.field.avoid_exercises_help':'Tätä käytetään sulkemaan selvät no-go-liikkeet pois ensisuosituksesta ja tulevasta treenin adaptoinnista.',
    ...
    'onboarding.recommend.first_step_with_time':'Aloita tänään treenillä {session}. Pidä se noin {time}.',
    'onboarding.recommend.first_step_default':'Aloita tänään treenillä {session}. Käytä ensimmäistä viikkoa karttana.',
    ...
    'onboarding.adjustment.short_session':'Ensimmäistä treeniä lyhennetään aikarajasi mukaan.',
    ...
    'history.stats_empty_sub':'Suorita muutama treeni nähdäksesi kehityksesi.',
    ...
    'settings.sport_load.section.guidance_sub':'Käytä nopeaa check-inia treenipäivänä, jotta treenin valinta reagoi lajikuormaan.',
    ...
    'settings.preferences.sport_check_help':'Kysy lajikuormasta tämän päivän ympärillä ennen treenin suosittelua.',
    ...
    'workout.summary.notes_placeholder':'Jäikö tästä treenistä jotain muistiin?',
    ...
    'workout.summary.log_post_workout_meal':'Kirjaa treenin jälkeinen ateria',
    ...
    'workout.program_error':'Treeni tallennettiin, mutta ohjelman tila kannattaa tarkistaa.',
    ...
    'workout.coach_note.pr_single':'Uusi ennätys, {exercise}! Jatka samaan malliin.',
    'workout.coach_note.pr_multi':'Uusia ennätyksiä, {exercises}! Loistava treeni.',
    'workout.coach_note.tm_increase':'Voima kasvaa: {lift} +{delta}kg → nyt {tm}kg',
    'workout.coach_note.week_advance':'Viikko {week} alkaa nyt. Rakenna sen päälle.',
    'workout.coach_note.cycle_advance':'Sykli {cycle} alkaa — uusi progressiolohko.',
    'workout.coach_note.tough_session':'Kova treeni — lepää hyvin ja palaa vahvempana.',
    'workout.coach_note.partial_session':'Osittainen treeni kirjattu. Mikä tahansa treeni lasketaan — jatkuvuus ratkaisee.',
    ...
    'workout.plan.train_light_copy':'Voit treenata tänään, mutta pidä kuormitus varovaisempana ja anna treenin hengittää.',
    ...
    'workout.start_override.recommended_copy':'Noudata tämän päivän palautumissuositusta ja pidä treeni kevyempänä.',
    ...
    'workout.session_mode.auto_copy_normal':'Noudata tämän päivän normaalia treenisuositusta automaattisesti.',
    ...
    'workout.session_mode.light_copy':'Aloita kevyempi treenivaihtoehto, vaikka päivä muuten olisi normaali.',
    ...
    'workout.runner.stop_after_this_copy':'Kun tämä liike on tehty, treenin tärkein työ on jo kasassa.',
    ...
    'workout.runner.light_confirm_body':'Tämä pitää treenin rakenteen pääosin samana, mutta keventää jäljellä olevaa kuormaa ja leikkaa hieman volyymia tarvittaessa. Käytä tätä kun palautuminen tuntuu heikolta.',
    ...
    'program.recommend_reason.starred_title':'Miksi suositeltu treeni on ehdotettu',
    'program.recommend_reason.progression':'Sopii ohjelman normaaliin etenemisjärjestykseen.',
    'program.recommend_reason.short_session':'Sopii lyhyempään treenitavoitteeseesi.',
    'program.recommend_reason.lower_volume':'Pitää kokonaistreenin hallittavampana tänään.',
    ...
    'rpe.session_prompt':'Arvioi treenin rasittavuus (6 = kevyt, 10 = maksimi)',
    'settings.program_setup_suffix':'Asetukset',
    'workout.log_extra_confirm':'Kirjataanko ylimääräinen {sport}-treeni tänne päivälle?',
    ...
    'workout.sport_check.inline_sub':'Käytä tämän päivän ympärillä olevaa lajikuormaa treenin suosittelun ohjaamiseen.',
    ...
    'workout.pref_adjustment.accessories':'Apuliikkeitä karsittiin lyhyempää treeniä varten.',
    'workout.pref_adjustment.aux_volume':'Apuliikkeiden volyymia vähennettiin aikakattoon sopivaksi.',
    'workout.pref_adjustment.sport_support':'Apuliikkeitä poistettiin, jotta treeni pysyy terävämpänä lajin tukemista varten.',
    ...
    'workout.pref_adjustment.sport_both':'Jalkoja kuormittavaa lajia on tämän treenin molemmin puolin, joten alavartalotyötä karsittiin.',
    ...
    'plan.insight.sport_collision':'Alavartalotyö törmää toistuvasti lajikuormaan viime treeneissäsi.',
    'plan.insight.adherence_30':'30 päivän toteuma: {done}/{expected} suunniteltua treeniä ({rate}%).',
    'plan.insight.best_days':'Treenaat useimmiten {days}.',
    'plan.recommend.continue':'Jatka samalla linjalla',
    'plan.recommend.continue_body':'Nykyinen setup näyttää kestävältä - jatka tasaisia onnistuneita treenejä.',
    'plan.recommend.shorten':'Lyhennä tätä viikkoa',
    'plan.recommend.shorten_body':'Aikakitkaa näkyy nyt, joten suosi tällä viikolla lyhyempiä mutta valmiita treenejä.',
    ...
    'dashboard.pref.goal.general_fitness':'Pidä treeni tänään kestävänä ja jätä hieman varaa tankkiin.',
    ...
    'dashboard.pref.time.long':'Tänään on aikaa täydemmälle treenille, joten tee apuliikkeetkin jos palautuminen pysyy hyvänä.',
    ...
    'dashboard.pref.equipment.minimal':'Välineitä on vähän, joten pidä treeni minimitehokkaana annoksena ja vaihda liikkeitä vapaasti tarvittaessa.',
    ...
    'program.w531.banner_leg_heavy':'suositeltu treeni kuormittaa jalkoja paljon.',
    ...
    'program.sl.split_overview':'A: Kyykky+Penkki+Soutu - B: Kyykky+Pystypunnerrus+Maastaveto - vuorotellen 3 treeniä/viikko',
    'program.sl.session_completed_next':'Treeni {count} valmis - Seuraava: Treeni {workout}',
    'program.sl.weight_rounding':'Painon pyöristys (kg)',
    'program.sl.working_weights':'Työpainot (kg)',
    'program.sl.progression_help':'Lisää +2.5kg (+5kg maastavedossa) onnistuneen treenin jälkeen. 3 epäonnistunutta treeniä käynnistää 10% kevennyksen.',
    ...
    'program.cfb.description':'Helppo saliohjelma pyörivillä kokovartalotreeneillä. Ei maksimeja tai suunnittelua.',
    ...
    'program.cfb.none':'-',
    'program.cfb.banner_sport_warning':'Treenissä on kyykkyjä ja lantionojennuksia. Kevennä tai lepää tarvittaessa.',
    ...
    'program.cfb.freq_reference':'Vain viitteellinen. Tämä ohjelma ei aikatauluta treenejä automaattisesti.',
    'program.cfb.movement_pools':'Liikemallien vaihtoehdot',
    'program.cfb.pool_help':'Jokainen treeni valitsee yhden liikkeen per paikka ja välttää edellisen treenin valintoja.',
    'program.cfb.slot5_accessories':'Paikka 5 - Apuliikkeet (2 valitaan per treeni)',
    ...
    'program.cfb.simple.overview':'Salin perusteet on helppo oletusohjelma: tule salille, tee tasapainoinen kokovartalotreeni ja anna liikevaihtelun hoitaa suunnittelu. Viikkotaajuus tulee nyt Treeni-preferensseistä.',
    ...
    'program.cfb.simple.summary':'{count} treeniä/viikko · tasapainoinen kokovartalotreeni',
    'program.forge.name':'Forge Protocol',
    ...
    'program.forge.banner_all_done':'Kaikki {count} treeniä tehty tällä viikolla! Palaudu rauhassa.',
    ...
    'program.forge.banner_recommended':'Suositus: <strong>Päivä {day}</strong> - {left} treeniä jäljellä tällä viikolla - Palautuminen {recovery}%',
    ...
    'program.forge.simple.summary':'{count} treeniä / viikko · {back} joka treenissä',
    ...
    'program.forge.simple.back_help':'Tämä liike tulee jokaisen treenin lopussa toistuvana selkäliikkeenä.',
    ...
    'program.w531.settings.in_season_help':'Valitse 2 apuliiketta per treeni (3 sarjaa × 10–15 toistoa kutakin).',
    ...
    'program.w531.simple.summary':'{season} · {freq} treeniä/viikko · Viikko {week}',
    ...
    'program.w531.plan.shoulder_trim':'Olkapäälle herkkä pystysuuntainen avustava työ priorisoitiin pois tästä treenistä.',
    ...
    'program.hs.banner_all_done':'✅ Kaikki treenit tehty tällä viikolla! Lepää.',
    'program.hs.banner_upper_rec':'suositellaan <strong>{session}</strong> (yläkroppapainotteinen).',
    'program.hs.banner_legs_only':'{sport} — vain jalkatreenejä jäljellä. Kevyemmin tai lepää.',
    ...
    'nutrition.clear.title':'Tyhjenn\u00e4 t\u00e4m\u00e4n p\u00e4iv\u00e4n sessio',
    'nutrition.clear.body':'T\u00e4m\u00e4 poistaa t\u00e4m\u00e4n p\u00e4iv\u00e4n ravintosession ja ateriacoachauksen.',
    'nutrition.empty.kicker':'AI-RAVINTOCOACH',
    'nutrition.empty.title':'P\u00e4ivitt\u00e4inen ravintocoachisi',
    'nutrition.empty.body':'Valitse toiminto alta ja saat räätälöityjä ravintoneuvoja tälle päivälle.',
    ...
    'nutrition.setup.body':'Lis\u00e4\u00e4 Claude API -avaimesi k\u00e4ytt\u00e4\u00e4ksesi ravintocoachia. Avain pysyy t\u00e4ll\u00e4 laitteella, ja ravintopyynn\u00f6t l\u00e4hetet\u00e4\u00e4n t\u00e4st\u00e4 selaimesta suoraan Anthropiciin.',
    'nutrition.setup.save':'Tallenna ja aloita',
    'nutrition.setup.help':'Hanki API-avain osoitteesta console.anthropic.com. K\u00e4yt\u00e4 omaa avainta ja v\u00e4lt\u00e4 jaettuja laitteita.',
    ...
    'nutrition.error.rate_limit':'Pyyntöraja saavutettu \u2014 odota hetki ja yritä uudelleen.',
    ...
    'nutrition.error.offline':'Olet offline-tilassa. Yhdistä internetiin ja yritä uudelleen.',
    ...
    'nutrition.banner.setup_body':'Aseta kehoprofiilisi räätälöityjä neuvoja varten',
    ...
    'settings.claude_api_key.placeholder':'sk-ant-...',
    'settings.claude_api_key.help':'Hanki API-avain osoitteesta console.anthropic.com. Avain pysyy t\u00e4ll\u00e4 laitteella, ja ravintopyynn\u00f6t l\u00e4hetet\u00e4\u00e4n t\u00e4st\u00e4 selaimesta suoraan Anthropiciin. K\u00e4yt\u00e4 omaa avainta ja v\u00e4lt\u00e4 jaettuja laitteita.',
    'settings.claude_api_key.save':'Tallenna avain',
    'settings.claude_api_key.saved_hint':'Avain on jo tallennettu t\u00e4lle laitteelle. Sy\u00f6t\u00e4 uusi vain jos haluat korvata sen.',
    'settings.claude_api_key.clear':'Poista avain',
    'settings.claude_api_key.invalid':'Sy\u00f6t\u00e4 kelvollinen Claude API -avain',
    ...
    /* ── Session character badge & pre-session note ───────────────── */
    'program.forge.character.deload':'Palautusviikko — kevyemmät painot, palautuminen',
    'program.forge.character.heavy':'Raskas — huippu\u00adsarjat {pct} % TM',
    'program.forge.character.strength':'Voima — {pct} % TM, hallittu volyymi',
    'program.forge.character.volume':'Hypertrofia — {pct} % TM, volyymin kasvatus',
    'program.forge.note.deload':'Viikko {week}/{total} — palautus. Kevyesti, anna palautumisen tapahtua.',
    ...
    'program.forge.note.rir_hint':'Huomioi jäljelle jäävät toistot viimeisessä sarjassa.',

    'program.w531.character.test':'TM-testi — vahvista treenimaksimit',
    'program.w531.character.deload':'Palautusviikko — kevyt palautumisviikko',
    'program.w531.character.amrap':'1+ viikko — AMRAP viimeisessä sarjassa, {pct} %',
    'program.w531.character.heavy':'3s viikko — työsarjat {pct} % TM',
    'program.w531.character.volume':'5s viikko — kohtalainen volyymi, {pct} % TM',
    'program.w531.note.test':'Sykli {cycle}, TM-testi — paina maksimitoistot jokaisessa nostossa.',
    'program.w531.note.deload':'Sykli {cycle}, palautus — kevyet sarjat, keskity palautumiseen.',
    'program.w531.note.amrap':'Sykli {cycle}, {scheme} — paina maksimitoistot jokaisessa AMRAP-sarjassa.',
    'program.w531.note.default':'Sykli {cycle}, {scheme} — suorita kaikki sarjat puhtaasti.',

    'program.sl.character.normal':'Lineaarinen 5×5 — lisää painoa onnistuessa',
    'program.sl.note.default':'Treeni {count} · Ohjelma {next}. Lisää painoa jos viimeksi kaikki 5×5 onnistui.',

    'program.cfb.character.normal':'Kokovartalo — vaihtelevat liikkeet',
    'program.cfb.note.default':'Treeni {count}{streak}. Keskity tekniikkaan ja intensiteettiin.',

    'program.hs.character.deload':'Palautusviikko — vähennetty volyymi, palautuminen',
    ...
    'program.hs.note.deload':'Sykli {cycle}, viikko {week} — palautus. Kevyemmät painot, anna kehon palautua.',
    'program.hs.note.default':'Sykli {cycle}, viikko {week}/8 — {block}-vaihe. Pysy johdonmukaisena volyymissa.'
  }
};
